        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden" id="example-collapse-sidebar">
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @can('user_management_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/permissions*")||request()->is("admin/roles*")||request()->is("admin/users*")||request()->is("admin/teams*")||request()->is("admin/team-roles*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                        ...
                        <ul class="ml-4 subnav hidden">
                            ...
                            @can('team_role_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/team-roles*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.team-roles.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon far fa-id-card">
                                        </i>
                ...
                @can('customer_management_access')
                    <li class="items-center">
                        ...
                        <ul class="ml-4 subnav hidden">
                            ...
                            @can('offer_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/offers*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.offers.index") }}">
                            ...
                            @can('newsletter_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/newsletters*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.newsletters.index") }}">
                            ...
                            @can('promotion_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/promotions*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.promotions.index") }}">
                ...
                @can('product_management_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/product-categories*")||request()->is("admin/product-tags*")||request()->is("admin/products*")||request()->is("admin/purchases*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                        ...
                        <ul class="ml-4 subnav hidden">
                            ...
                            @can('purchase_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/purchases*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.purchases.index") }}">
