                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'max_coupons_count'])
                        </th>
                        <th>
                            {{ trans('cruds.product.fields.max_offers_count') }}
                            @include('components.table.sort', ['field' => 'max_offers_count'])
                        </th>
                        <th>
                            {{ trans('cruds.product.fields.max_newsletter_count') }}
                            @include('components.table.sort', ['field' => 'max_newsletter_count'])
                        </th>
                        <th>
                            {{ trans('cruds.product.fields.max_promotions_count') }}
                            @include('components.table.sort', ['field' => 'max_promotions_count'])
                        </th>
                        <th>
                            {{ trans('cruds.product.fields.max_members_count') }}
                            @include('components.table.sort', ['field' => 'max_members_count'])
                        </th>
                        <th>
                            {{ trans('cruds.product.fields.max_newsletter_global') }}
                            @include('components.table.sort', ['field' => 'max_newsletter_global'])
                        </th>
                        <th>
                            {{ trans('cruds.product.fields.max_promotions_global') }}
                            @include('components.table.sort', ['field' => 'max_promotions_global'])
                        </th>
                        <th>
                        </th>
                    </tr>
